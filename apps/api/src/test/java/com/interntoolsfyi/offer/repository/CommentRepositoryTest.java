...
class CommentRepositoryTest {
  ...
  void findByPostExcludesDeletedComments() {
    ...
    Post post = PostFixtures.savePublishedPost(author, "Post", offerRepository, postRepository);
  ...
  void findByIdAndUserReturnsOnlyOwnedComment() {
    ...
    Post post = PostFixtures.savePublishedPost(author, "Post2", offerRepository, postRepository);
